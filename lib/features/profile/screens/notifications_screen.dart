...
class NotificationsScreen extends StatelessWidget {
  ...
  Widget _item(AppNotification n) => Container(
        ...
        child: Row(
          ...
          children: [
            CircleAvatar(radius: 21, backgroundColor: n.iconBg, child: Text(n.icon, style: const TextStyle(fontSize: 18))),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(n.timeLabel, style: const TextStyle(fontSize: 11, color: AppColors.textTertiary)),
                ],
              ),
            ),
          ],
