  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          _card('👤 Khách hàng', const Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('Nguyễn Văn An', style: TextStyle(fontWeight: FontWeight.w700)),
              Text('0912 345 678 · an.nguyen@email.com', style: TextStyle(color: AppColors.textSecondary, fontSize: 13)),
            ],
          )),
          _card('📍 Địa chỉ giao hàng', const Text('123 Đường Nguyễn Huệ, P. Bến Nghé, Q.1, TP.HCM',
              style: TextStyle(color: AppColors.textSecondary, fontSize: 13))),
          _card('Sản phẩm', Column(
            children: MockData.cartItems().map((i) => Padding(
          ...
          const Text('Cập nhật trạng thái', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 13)),
